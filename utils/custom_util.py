...
def draw_poly_area_dangerous(img):
    """
    画多边形危险区域的框
    ...
    :return: None
    """
    area1 = [[272, 100], [10, 100], [10, 500], [263, 500]]
    area= [[272, 57], [553, 55], [541, 413], [263, 395]]
    area_poly = np.array( area1, np.int32)
...
def person_in_poly_area_dangerous(xyxy):
    """
    检测人体是否在多边形危险区域内
    :param xyxy: 人体框的坐标
    :param img_name: 检测的图片标号，用这个来对应图片的危险区域信息
    ...
    """
    area = [[272, 100], [10, 100], [10, 500], [263, 500]]
    print(area)
    if not area:  # 为空
        return False
    ...
    return is_poi_in_poly([object_cx, object_cy],area)
